...
**Note**: If you want to configure Blob Storage during the installation, refer [Configure Blob Storage During Installation](install-devtron-with-cicd-with-gitops.md#configure-blob-storage-during-installation).
...
Refer to the `AWS specific` parameters on the [Storage for Logs and Cache](../configurations-overview/installation-configuration.md#aws-specific) page.
...
Refer to the `Azure specific` parameters on the [Storage for Logs and Cache](../configurations-overview/installation-configuration.md#azure-specific) page.
...
Refer to the `Google Cloud specific` parameters on the [Storage for Logs and Cache](../configurations-overview/installation-configuration.md#google-cloud-storage-specific) page.
