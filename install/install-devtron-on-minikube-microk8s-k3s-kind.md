...
{% embed url="https://www.youtube.com/watch?v=rKUymNJqcjA" %}
...
Ensure you meet [all the requirements](../getting-started.md#prerequisites) for installing Devtron.
{% endhint %}
...
You can also install integrations from the [Devtron Stack Manager](../usage/integrations/).
