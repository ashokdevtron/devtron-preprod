...
When you commit the code, it's essential to scan it before building a [container image](../../resources/glossary.md#image). By scanning early, you can catch and fix problems before they become expensive or time-consuming to remediate later.
...
* Image scan in the Build stage (refer [Security Scans](security-scans.md))
...
1. [**Security Scans**](security-scans.md) - You can view the vulnerabilities detected across your applications.
2. [**Security Policies**](security-policies.md) - This allows you to define guardrails to block or allow the deployment of container images depending on the vulnerabilities detected.
