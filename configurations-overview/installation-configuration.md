...
5. **clairv4** - (_Optional_) Required only if you are using [Clair](../usage/integrations/vulnerability-scanning/clair.md) for image scanning instead of [Trivy](../usage/integrations/vulnerability-scanning/trivy.md)
