...
In such cases, contact [Devtron Support](https://github.com/devtron-labs/devtron-documentation/blob/main/docs/setup/install/support@devtron.ai).
{% endhint %}
...
Visit the [Troubleshoot](freemium.md#troubleshoot-issues) section to identify the issue or connect with [Devtron Support](https://github.com/devtron-labs/devtron-documentation/blob/main/docs/setup/install/support@devtron.ai).
{% endhint %}
...
After the initial login, we recommend you set up any [Single Sign-On (SSO) service](global-configurations/authorization/sso-login/) like Google, GitHub, etc., and then add other users (including yourself). Subsequently, all the users can use the same SSO (let's say, GitHub) to log in to the Dashboard.
{% endhint %}
...
If you need help, contact [Devtron Support](https://github.com/devtron-labs/devtron-documentation/blob/main/docs/setup/install/support@devtron.ai).
