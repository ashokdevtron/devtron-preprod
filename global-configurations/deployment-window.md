...
The **Deployment window** section shows the blackout and maintenance windows configured for each [environment](../resources/glossary.md#environment) of the application.
...
Just like application, [application groups](../usage/application-groups.md) are also subjected to deployment windows.
