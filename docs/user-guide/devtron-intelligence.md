...
Check out the [Results](devtron-intelligence.md#results) section to see where Devtron gives you AI-powered explanation for troubleshooting.
...
* [Method A: Using 'Create Resource'](devtron-intelligence.md#method-a-using-create-resource)
* [Method B: Using kubectl command](devtron-intelligence.md#method-b-using-kubectl-command)
...
3. Paste the following YAML and replace the key with your base64-encoded OpenAI key. Also, enter the namespace where the [AI Agent chart](devtron-intelligence.md#id-3.-deploy-ai-agent-chart) will be installed:
...
{% hint style="success" %}
Unlike [Method A](devtron-intelligence.md#method-a-using-create-resource), this method doesn't require you to encode your LLM Key to Base64 format.
{% endhint %}

1. Go to Devtron's [Resource Browser](resource-browser/) and click the [terminal icon](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/kubernetes-resource-browser/cluster-terminal.gif) next to the cluster where you wish to create the secret.
...
4. In the left-hand pane:
   ...
   * **Deploy to environment**: Choose the target environment (should be associated with the same namespace used while creating secret key in [Step 2](devtron-intelligence.md#id-2.-create-secret-in-devtron))
