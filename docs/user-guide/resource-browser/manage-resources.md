...
You can edit the [manifest](../../reference/glossary.md#manifest) of a Kubernetes object. This can be for fixing errors, scaling resources, or changing configuration. Moreover, you can edit a manifest [using YAML](manage-resources.md#edit-using-yaml) or [GUI](manage-resources.md#edit-using-gui), as per your convenience.
