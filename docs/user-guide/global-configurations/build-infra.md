...
Modern applications often need to run on different hardware platforms (architectures), such as `amd64` (x86\_64) and `arm64` to support cross-platform compatibility.
